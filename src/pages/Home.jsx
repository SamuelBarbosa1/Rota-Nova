...
export default function Home() {
  ...
  const [quickOrigin, setQuickOrigin] = useState("Av. Paulista, 1000 — SP");
  const [quickDest, setQuickDest] = useState("Rua do Bosque (Estrada de Chão)");
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-emerald-500 selection:text-slate-950">
      ...
      <section className="relative pt-12 pb-24 overflow-hidden border-b border-slate-800/80">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-emerald-500/15 rounded-full blur-[140px] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="inline-flex items-center space-x-2 bg-emerald-950/80 border border-emerald-800/60 px-4 py-2 rounded-full text-xs font-semibold text-emerald-300 shadow-inner">
              ...
              <p className="text-lg sm:text-xl text-slate-300 font-normal leading-relaxed max-w-2xl">
                O <strong className="text-white font-semibold">RotaJá</strong> conecta clientes e motoristas com cadastro simples, entrevista prévia obrigatória e regra rígida de compromisso: <span className="text-emerald-400 font-semibold underline decoration-emerald-500/50 decoration-2">aceitou a corrida, leva até o destino final</span>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                <button
                  ...
                  className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold text-base px-8 py-4 rounded-xl shadow-xl shadow-emerald-500/25 transition-all transform hover:-translate-y-0.5 flex items-center justify-center space-x-2"
                >
                ...
                <button
                  ...
                  className="bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700/80 font-bold text-base px-7 py-4 rounded-xl transition-all flex items-center justify-center space-x-2 hover:border-emerald-500/50"
                >
              ...
              {/* Trust badges */}
              <div className="pt-6 grid grid-cols-3 gap-4 border-t border-slate-800/80 text-slate-400 text-xs sm:text-sm">
            ...
            <div className="lg:col-span-5">
              <div className="glass-panel p-6 rounded-3xl shadow-2xl border border-slate-800 space-y-6">
                ...
                <form onSubmit={handleQuickEstimate} className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-slate-900 border border-slate-700/80 rounded-xl px-4 py-3 pl-10 text-sm text-white focus:outline-none focus:border-emerald-500"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-slate-800 hover:bg-slate-700 text-emerald-400 font-bold py-3 rounded-xl border border-emerald-500/30 transition-all text-sm"
                  >
                ...
                {isCalculated && (
                  <div className="bg-emerald-950/60 border border-emerald-800/80 p-4 rounded-xl space-y-2 animate-fadeIn">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-slate-300">Estimativa RotaJá Padrão:</span>
                      <span className="text-xl font-black text-emerald-400">R$ {estimatedPrice}</span>
                    </div>
                    <p className="text-[11px] text-slate-400">
                      Garantia RotaJá: O motorista que aceitar esta viagem não poderá cancelar por motivo de rua ou bairro.
                    </p>
                    <button
                      onClick={() => openAuth('cliente')}
                      className="w-full text-center bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold py-2.5 rounded-lg text-xs transition-colors mt-2"
                    >
      ...
      <section className="py-20 bg-slate-900/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            <h2 className="text-xs font-extrabold uppercase tracking-widest text-emerald-400">Como funciona o RotaJá</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="glass-card p-6 rounded-2xl border border-slate-800 space-y-4">
              ...
              <button
                onClick={() => openAuth('motorista')}
                className="inline-flex items-center text-xs font-bold text-teal-400 hover:underline"
              >
            ...
            <div className="glass-card p-6 rounded-2xl border border-slate-800 space-y-4">
              ...
              <Link to="/regras" className="inline-flex items-center text-xs font-bold text-emerald-400 hover:underline">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950/60 rounded-3xl border border-emerald-500/30 p-8 sm:p-12 relative overflow-hidden shadow-2xl">
            ...
            <div className="max-w-3xl space-y-6 relative z-10">
              ...
              <p className="text-slate-300 text-base leading-relaxed">
                Seja o destino no centro, em um bairro afastado, comunidade, viela ou rua de terra: <strong className="text-emerald-400">recusar passageiros por localização é infração grave.</strong>
              </p>

              <Link
                to="/regras"
                className="inline-flex items-center space-x-2 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black px-6 py-3.5 rounded-xl text-sm transition-all shadow-lg"
              >
      ...
      <section className="py-16 bg-slate-900/40 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="flex justify-between items-end">
            <div>
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-widest">Demonstração ao Vivo</span>
              <h2 className="text-3xl font-black text-white">Visualizador do Radar RotaJá</h2>
            </div>
          </div>
          <InteractiveMap
            origin="Av. Paulista, 1000 — São Paulo, SP"
            destination="Estrada do Campo Limpo, Km 4 (Entrada de Chão)"
            status="idle"
