...
export default function Motorista() {
  ...
  const questions = [
    {
      id: 1,
      question: "O cliente solicita uma corrida e o destino final é uma estrada de chão / rua de terra. Qual é a conduta exigida pela RotaJá?",
      options: [
      ...
      explanation: "No RotaJá, o acesso a estradas de chão ou vias não asfaltadas faz parte da mobilidade democrática e NUNCA é motivo de cancelamento."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      options: [
        { key: 'A', text: "Descredenciamento e banimento definitivo da conta RotaJá.", correct: true },
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 py-16 flex items-center justify-center">
        <div className="max-w-xl mx-auto px-4 text-center">
          <div className="glass-panel p-8 sm:p-10 rounded-3xl border border-slate-800 space-y-6 shadow-2xl">
            ...
            <div className="w-16 h-16 rounded-2xl bg-teal-500/20 text-teal-400 border border-teal-500/30 mx-auto flex items-center justify-center">
              <Lock className="w-8 h-8" />
            </div>

            <div className="space-y-2">
              <span className="text-xs font-bold text-teal-400 uppercase tracking-widest">Portal Restrito do Condutor</span>
  ...
  const simulateIncomingCall = () => {
    setActiveCall({
      ...
      dropoff: 'Rua das Palmeiras, 80 (Bairro Periférico - Estrada de Terra)',
      price: 'R$ 38,40',
      distance: '8.2 km',
      passenger: 'Carlos M.'
    });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="glass-panel p-8 rounded-3xl border border-slate-800 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 rounded-2xl bg-teal-500/20 text-teal-400 border border-teal-500/40 flex items-center justify-center font-black text-2xl shadow-lg">
              {driverName.substring(0, 2).toUpperCase()}
            </div>
            <div>
              <div className="flex items-center space-x-2">
                <span className="text-xs font-bold text-teal-400 bg-teal-950 border border-teal-800 px-2.5 py-0.5 rounded-full">
                  ✓ MOTORISTA CREDENCIADO & ENTREVISTADO
                </span>
              </div>
              ...
              <p className="text-slate-400 text-xs mt-0.5">
                {carModel} • Placa <strong className="text-slate-200">{carPlate}</strong> • Avaliação: <strong className="text-amber-400">4.98 ★</strong>
              </p>
            </div>
          </div>
        ...
        {activeTab === 'cockpit' && (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="glass-panel p-6 rounded-3xl border border-emerald-500/40 flex flex-col md:flex-row items-center justify-between gap-6">
              
              <div className="flex items-center space-x-3">
                <div className={`w-3.5 h-3.5 rounded-full ${isOnline ? 'bg-emerald-400 animate-ping' : 'bg-slate-500'}`}></div>
                <div>
                  <h3 className="text-base font-black text-white">
                    {isOnline ? 'Modo Online — Prontidão RotaJá' : 'Modo Offline (Pausa)'}
                  </h3>
            ...
            <div className="glass-panel p-8 rounded-3xl border border-slate-800 space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div>
                  <h3 className="text-xl font-bold text-white flex items-center gap-2">
                    ...
                    Radar de Corridas RotaJá em Tempo Real
                  </h3>
                ...
                {isOnline && !activeCall && !acceptedRide && (
                  <button
                    ...
                    className="bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-400 border border-emerald-500/40 font-bold px-4 py-2 rounded-xl text-xs transition-colors"
                  >
              ...
              {activeCall && (
                <div className="bg-slate-900 border-2 border-emerald-500 p-6 rounded-2xl space-y-4 animate-bounce-subtle">
                  ...
                  <div className="bg-emerald-950/80 border border-emerald-800 p-3 rounded-xl text-xs text-emerald-300 font-medium">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black py-3.5 rounded-xl shadow-lg transition-colors text-sm"
                    >
              ...
              {acceptedRide && (
                <div className="bg-emerald-950/60 border border-emerald-500/60 p-6 rounded-2xl space-y-4">
                  <div className="flex items-center justify-between">
                    <h4 className="text-base font-bold text-white flex items-center gap-2">
                      <CheckCircle2 className="w-5 h-5 text-emerald-400" />
                      Corrida em Andamento (Regra Aceitou, Levou Ativa)
                    </h4>
                    <span className="text-sm font-black text-emerald-400">{acceptedRide.price}</span>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black py-3 rounded-xl text-xs transition-colors"
                    >
              ...
              {!activeCall && !acceptedRide && (
                <div className="text-center py-12 text-slate-500 space-y-2">
                  ...
                  <p className="text-xs">O radar RotaJá prioriza motoristas credenciados com nota alta.</p>
                </div>
              )}
          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="glass-panel p-6 rounded-2xl border border-slate-800">
                ...
                <p className="text-3xl font-black text-emerald-400 mt-2">R$ 3.420,00</p>
                <p className="text-[11px] text-slate-400 mt-1">Acumulado de 58 corridas</p>
              </div>

              <div className="glass-panel p-6 rounded-2xl border border-slate-800">
                <p className="text-xs text-slate-400 font-semibold uppercase">Taxa RotaJá (10%)</p>
                <p className="text-3xl font-black text-rose-400 mt-2">-R$ 342,00</p>
              ...
              <div className="glass-panel p-6 rounded-2xl border border-slate-800">
                ...
                <p className="text-3xl font-black text-amber-400 mt-2">-R$ 680,00</p>
                <p className="text-[11px] text-slate-400 mt-1">Calculado sobre 480 km rodados</p>
              </div>

              <div className="glass-panel p-6 rounded-2xl border border-slate-800 bg-gradient-to-br from-emerald-950/60 to-slate-900">
                <p className="text-xs text-emerald-300 font-bold uppercase">LUCRO LÍQUIDO NO BOLSO</p>
                <p className="text-3xl font-black text-emerald-400 mt-2">R$ 2.398,00</p>
                <p className="text-[11px] text-emerald-300 mt-1">~ R$ 54,50 / hora rodada</p>
              </div>
              ...
              <div className="lg:col-span-7 glass-panel p-6 rounded-3xl border border-slate-800 space-y-6">
                ...
                <div className="space-y-4 text-xs">
                  <div className="flex justify-between p-3 bg-slate-900 rounded-xl border border-slate-800">
                    ...
                    <span className="font-black text-emerald-400">R$ 3.420,00</span>
                  </div>
                  <div className="flex justify-between p-3 bg-slate-900 rounded-xl border border-slate-800">
                    <span className="text-slate-300">Desconto Taxa de Serviço RotaJá (10%)</span>
                    <span className="font-black text-rose-400">- R$ 342,00</span>
                  </div>
                  <div className="flex justify-between p-3 bg-slate-900 rounded-xl border border-slate-800">
                    <span className="text-slate-300">Est. Combustível (Gasolina/Etanol/GNV)</span>
                    <span className="font-black text-amber-400">- R$ 680,00</span>
                  </div>
                  <div className="flex justify-between p-4 bg-emerald-950 border border-emerald-500 rounded-xl font-bold text-sm">
                    <span className="text-white">Resultado Líquido Final</span>
                    <span className="text-emerald-400 font-black">R$ 2.398,00</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 glass-panel p-6 rounded-3xl border border-slate-800 space-y-6">
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div className="p-3.5 bg-slate-900 rounded-xl border border-slate-800 flex justify-between items-center">
                    ...
                    <span className="font-extrabold text-emerald-400">0 (Nenhum)</span>
                  </div>
                  <div className="p-3.5 bg-slate-900 rounded-xl border border-slate-800 flex justify-between items-center">
                    <span>Avaliação Média</span>
                    <span className="font-extrabold text-amber-400">4.98 ★</span>
                  </div>
                </div>
              </div>
        ...
        {activeTab === 'entrevista' && (
          <div className="glass-panel p-8 rounded-3xl border border-slate-800 max-w-4xl mx-auto space-y-6 animate-fadeIn">
            ...
            <div className="border-b border-slate-800 pb-4">
              ...
              <p className="text-xs text-slate-400 mt-1">Sua avaliação de conduta foi concluída com aprovação máxima.</p>
            </div>
            ...
            <div className="bg-emerald-950/60 border border-emerald-500/40 p-6 rounded-2xl space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="text-lg font-black text-white">Certificado de Aprovação de Conduta RotaJá</h4>
          ...
          <div className="glass-panel max-w-md w-full p-6 rounded-3xl border border-rose-500/40 shadow-2xl space-y-4">
            ...
            {!exceptionSubmitted ? (
              ...
              <div className="text-center py-4 space-y-3">
                <p className="text-sm font-bold text-emerald-400">✓ Ocorrência enviada para auditoria RotaJá sem penalidade.</p>
                <button
                  onClick={() => {
