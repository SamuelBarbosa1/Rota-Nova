...
import { 
  ...
  Briefcase, Mail, Phone, ExternalLink, Flame
} from 'lucide-react';
...
export default function Investidor() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 py-10 selection:bg-amber-500 selection:text-slate-950 animate-fadeIn">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="glass-panel p-8 rounded-3xl border border-slate-800 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-3 bg-slate-900/80 p-3 rounded-2xl border border-slate-800">
            ...
            <div className="text-left">
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Taxa de Crescimento MoM</span>
              <span className="text-sm font-black text-emerald-400">+28.4% de aumento este mês</span>
            </div>
          </div>

        </div>

        {/* 1. SEÇÃO DE USUÁRIOS REGISTRADOS (ESTILO REFERÊNCIA DO USUÁRIO) */}
        ...
        {/* 2. SEÇÃO DE METAS E VENDAS (VOLUME BRUTO / GMV - INSPIRADO NA IMAGEM) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          
          <div className="lg:col-span-7 glass-panel p-8 rounded-3xl border border-slate-800 space-y-6 shadow-2xl">
          ...
          <div className="lg:col-span-5 glass-panel p-8 rounded-3xl border border-slate-800 space-y-6 shadow-2xl flex flex-col justify-between">
        ...
        {/* 3. EVOLUÇÃO, RESULTADOS & NOVIDADES DA PLATAFORMA */}
        ...
        {/* 4. SIMULADOR DE APORTE & CONTATO DIRETO */}
        <div className="glass-panel p-8 sm:p-10 rounded-3xl border border-amber-500/40 bg-gradient-to-br from-slate-900 via-slate-900 to-amber-950/40 space-y-8">
