-- ==============================================================================
-- ROTA NOVA — SCRIPT DE INICIALIZAÇÃO SUPABASE (POSTGRESQL + REALTIME + RLS)
...
CREATE TABLE IF NOT EXISTS users (
    ...
    role VARCHAR(32) NOT NULL DEFAULT 'cliente', -- 'cliente' | 'motorista' | 'admin' | 'investidor'
...
CREATE TABLE IF NOT EXISTS rides (
    id VARCHAR(64) PRIMARY KEY,
    ride_code VARCHAR(32) UNIQUE NOT NULL,
    ...
    category VARCHAR(64) NOT NULL DEFAULT 'via_go',
...
-- 6. TABELA FINANCEIRA DO MOTORISTA (Livro Razão)
CREATE TABLE IF NOT EXISTS driver_financial_ledger (
    ...
    fuel_estimate_amount DECIMAL(10, 2) DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS conduct_reports (
    ...
    penalty_applied VARCHAR(64),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);

-- ==============================================================================
-- DADOS INICIAIS (SEED) PARA TESTES IMEDIATOS
-- ==============================================================================
...
-- ==============================================================================
-- ROW LEVEL SECURITY (RLS) & POLÍTICAS PARA ACESSO WEB/APP
-- ==============================================================================

ALTER TABLE users ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Permitir leitura e escrita users" ON users FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE driver_profiles ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Permitir leitura e escrita driver_profiles" ON driver_profiles FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE saved_locations ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Permitir leitura e escrita saved_locations" ON saved_locations FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE rides ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Permitir leitura e escrita rides" ON rides FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE ride_ratings ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Permitir leitura e escrita ride_ratings" ON ride_ratings FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE driver_financial_ledger ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Permitir leitura e escrita driver_financial_ledger" ON driver_financial_ledger FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE conduct_reports ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Permitir leitura e escrita conduct_reports" ON conduct_reports FOR ALL USING (true) WITH CHECK (true);

-- ==============================================================================
-- ATIVAR REALTIME (Notificações instantâneas de corridas para motoristas e clientes)
-- ==============================================================================
DO $$
BEGIN
  IF NOT EXISTS (
